                ...
                <label
                  ...
                  className={clsx(
                    ...
                    (item.key === "transmission"
                      ...
                      : localFilters[item.key as keyof typeof localFilters]) &&
                      styles.checked
                  )}
                >
                  <input
                    ...
                    onChange={() => {
                      if (item.key === "transmission") {
                        ...
                        handleCheckboxChange(item.key as any);
                      }
                    }}
                  />
                  <Icon id={item.icon} className={styles.filterIcon} />
                  <span className={styles.filterText}>{item.label}</span>
                </label>
              ))}
            </div>
          </div>
            ...
            <div className={styles.radioGrid}>
              {[
                ...
                <label
                  ...
                  className={clsx(
                    styles.radioLabel,
                    localFilters.form === item.value && styles.checked
                  )}
                  onClick={(e) => {
                    e.preventDefault();
                    const newValue =
                      localFilters.form === item.value ? "" : item.value;
                ...
                >
                  <input
                    ...
                    name="form"
                    value={item.value}
                    checked={localFilters.form === item.value}
                    readOnly
